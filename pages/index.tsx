...
export default function Home() {
    ...
    const copy = () => {
        navigator.clipboard.writeText(`[![Discord Presence](https://lanyard-profile-readme-nyria.vercel.app/api/${userId}
            ...
            <Main>
                <Container>
                    ...
                    {userId ? (
                        <>
                            <Output>
                                [![Discord Presence](https://lanyard-profile-readme-nyria.vercel.app/api/{userId}
                                )](https://discord.com/users/{userId})
                            </Output>
